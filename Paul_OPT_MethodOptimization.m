%% Paul_OPT_MethodOptimization.m (version 3.2)
%Author: Paul Ernst
...
%PE 6/2/2022 - Adjusted to work for Methods
...
%--------------------------------------
%Purpose: Takes a request for comparing eddy tracking methods and does so (METHOD - FIG5)
...
%--------------------------------------
%% Inputs
function Paul_OPT_MethodOptimization(inputDir)
load('DefaultData_OPT.mat') %See Paul_OPT_CreateDefaultSettings.m
Paul_OPT_LoadDefaultSettings(); %See corresponding function

%Title for info mat
titlestring = ["OPT_FINAL"];
%METHODS
centerMethods = ["PV_ISO","OW_WA","OW_T","VORT_WA","VORT_T","LNAM"]; %list of methods to find center: SSH, PV_ISO, VORT, MV, OW, VG, LNAM
edgeMethods = ["PV_ISO","OW_WA","OW_T","VORT_WA","VORT_T"]; %list of methods to find edge: SSH, PV_ISO, VORT, MV, OW, VG
...
minAmp = 0;
minRatio = 0; %0 - 0.3 is our minimum threshold for ellipsoidness
    ...
    for fileNum = 1:length(list)
        ...
        switch centerMethod
            ...
            case "VORT_T"
                ...
                prevString = "OPT_C_VORT_T_STD";
                load("IO_" + prevString + "_Comparisons.mat", "winner")
                thisSTD = winner;
                centerField{1,3} = thisSTD;
                prevString = "OPT_C_VORT_T_SMTH";
                load("IO_" + prevString + "_Comparisons.mat", "winner")
                thisSmoothingFactor = winner;
            ...
            case "OW_T"
                ...
                prevString = "OPT_C_OW_T_STD";
                load("IO_" + prevString + "_Comparisons.mat", "winner")
                thisSTD = winner;
                centerField{1,3} = thisSTD;
                prevString = "OPT_C_OW_T_SMTH";
                load("IO_" + prevString + "_Comparisons.mat", "winner")
                thisSmoothingFactor = winner;
                centerField{1,4} = thisSmoothingFactor;
            case "LNAM"
        ...
        switch edgeMethod
            ...
            case "PV_ISO"
                ...
                prevString = "OPT_E_PV_ISO_SMTHRAT";
                load("IO_" + prevString + "_Comparisons.mat", "winner","winner2")
                thisSmoothingFactor = winner;
            ...
            case "VORT_WA"
                edgeField = cell(1,2);
                edgeField{1,1} = VORT;
                prevString = "OPT_E_VORT_WA_SMTHRAT";
                load("IO_" + prevString + "_Comparisons.mat", "winner", "winner2")
                thisSmoothingFactor = winner;
                edgeField{1,2} = thisSmoothingFactor;
                thisRatio = winner2;
            case "VORT_T"
                ...
                prevString = "OPT_E_VORT_T_SMTHRAT";
                load("IO_" + prevString + "_Comparisons.mat", "winner", "winner2")
                thisSmoothingFactor = winner;
            ...
            case "OW_WA"
                edgeField = cell(1,3);
                edgeField{1,1} = OW;
                prevString = "OPT_E_OW_WA_SMTHRAT";
                load("IO_" + prevString + "_Comparisons.mat", "winner", "winner2")
                thisSmoothingFactor = winner;
                edgeField{1,2} = thisSmoothingFactor;
                thisRatio = winner2;
...
save(filename_out, "totalSims","totalRatio","totalSpatialC","totalSpatialR","totalNum",...
    "masterMethods","masterDirList","inputDir","datetimeNow","xToPlot");
