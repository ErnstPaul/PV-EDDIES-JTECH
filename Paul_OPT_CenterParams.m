%% Paul_OPT_CenterParams.m (version 3.1)
%Author: Paul Ernst
%Date Created: 5/10/2022
%Date of Last Update: 1/12/2022
%Update History:
...
%--------------------------------------
%Purpose: Takes a request for comparing eddy tracking methods and does so (CENTER-PARAMS, FIG1)
...
%--------------------------------------
%% Inputs
function Paul_OPT_CenterParams(inputDir)
load('DefaultData_OPT.mat') %See Paul_OPT_CreateDefaultSettings.m
Paul_OPT_LoadDefaultSettings(); %See corresponding function

%Title for info mat
titlestrings = ["OPT_C_OW_T_STD" "OPT_C_VORT_T_STD" "OPT_LNAM_K"];
RPT = length(titlestrings);
%METHODS
centerMethodss = ["OW_T","VORT_T","LNAM"]; %list of methods to find center: SSH, PV_ISO, VORT, MV, OW, VG, LNAM
